...
def beers(request):
    ...
    return render_to_response('browse/beers.html', {'list_of_beers': list_of_beers, 'list_of_breweries': list_of_breweries}, context_instance=RequestContext(request))
    
def breweries(request):
     list_of_breweries = Brewery.objects.all().order_by('name')
     return render_to_response('browse/breweries.html', {'list_of_breweries': list_of_breweries}, context_instance=RequestContext(request))
...
def brewerydetail(request, brewery_id):
    ...
    return render_to_response('browse/brewerydetail.html', {'brewery': brewery, 'list_of_beers': list_of_beers}, context_instance=RequestContext(request))

def styles(request):
    list_of_styles = Style.objects.all().order_by('style_name')
    return render_to_response('browse/styles.html', {'list_of_styles': list_of_styles}, context_instance=RequestContext(request))
...
list_of_beers, 'list_of_breweries': list_of_breweries}, context_instance=RequestContext(request))
...
list_of_categories}, context_instance=RequestContext(request))
...
list_of_locations}, context_instance=RequestContext(request))
